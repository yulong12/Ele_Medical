<template>
    <div class="queryDepartment">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" class="addForm">
        ...
        <el-form-item label="备注" prop="attention">
          <el-input v-model="form.attention"></el-input>
        </el-form-item>
...
.queryDepartment .el-input
  width:384px
.queryDepartment .tittle
  display:block
  text-align: center
  font-size:24px
  font-weight:600
  line-height:80px
.queryDepartment .addForm
  width:470px
  margin:auto
.queryDepartment .addForm .buttonAdd
  text-align: center;
</style>