<template>
  <div class="registerManage">
    ...
    <el-table :data="patients" border style="width: 100%; text-align:left">
      ...
      <el-table-column prop="registerKind" label="挂号凭证"></el-table-column>
      <el-table-column prop="idCard" label="凭证号"></el-table-column>
      ...
      <el-table-column prop="waitingNo" label="候诊号"></el-table-column>
      <el-table-column prop="fee" label="挂号费"></el-table-column>
    ...
    <el-dialog title="患者挂号信息" :visible.sync="dialogVisible" :before-close="handleClose">
      <ul class="patientsdetail">
        ...
        <li><h5>挂号凭证:</h5><span>{{patientsdetails.registerKind}}</span></li>
        <li><h5>凭证号：</h5><span>{{patientsdetails.idCard}}</span></li>
        <li><h5>性别:</h5><span>{{patientsdetails.sex}}</span></li>
        <li><h5>年龄:</h5><span>{{patientsdetails.age}}</span></li>
        <li><h5>家庭地址:</h5><span>{{patientsdetails.address}}</span></li>
        ...
        <li><h5>候诊号:</h5><span>{{patientsdetails.waitingNo}}</span></li>
        <li><h5>挂号费:</h5><span>{{patientsdetails.fee}}</span></li>
      </ul>
